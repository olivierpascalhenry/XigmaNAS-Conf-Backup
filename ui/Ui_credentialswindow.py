...
"}")
    ...
    def retranslateUi(self, credentialsWindow):
        ...
        self.label_1.setText(_translate("credentialsWindow", "<html><head/><body><p>There is no password and/or username stored in the Option .ini file. The username and password of an authorized account are necessary to download the configuration file. The username and password entered in the present window are not stored and used only for SSH authentication.</p></body></html>"))
