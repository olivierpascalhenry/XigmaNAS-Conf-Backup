...
"}")
    ...
    def retranslateUi(self, aboutlogWindow):
        ...
        aboutlogWindow.setWindowTitle(_translate("aboutlogWindow", "About XigmaNAS Conf Backup"))
        self.label_1.setText(_translate("aboutlogWindow", "<html><head/><body><p>The following software was developed by Olivier Henry, using Eclipse 4.7.3, Python 3.5 and PyQt 5.10. It was designed to make a backup of the configuration file of XigmaNAS using Python and scp commands.</p></body></html>"))
